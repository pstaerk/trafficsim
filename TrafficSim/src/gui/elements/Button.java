...
public class Button implements Drawable
{
    ...
    public void changeColors(ButtonColorTemplate colors)
    {
        this.colorNormal = colors.colorNormal;
        this.colorHover = colors.colorHover;
    ...
    public static class ButtonColorTemplate
    {
        private final Color colorNormal;
        private final Color colorHover;
        private final Color colorFont;

        public ButtonColorTemplate(Color colorNormal , Color colorHover , Color colorFont)
        {
            this.colorNormal = colorNormal;
            this.colorHover = colorHover;
            this.colorFont = colorFont;
